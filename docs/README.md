...
| [weekly-planner-spec.md](weekly-planner-spec.md) | proposal | The learner's week: courses as enrolments, tasks, tests planned backwards into study sessions with a purpose, priorities/wins/goals, and how grown-ups collaborate on it. |
